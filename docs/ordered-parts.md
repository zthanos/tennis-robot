...
Παραγγελία Skroutz: `260531-7129740`  
Ημερομηνία παραγγελίας: `31/05/2026 11:51 μ.μ.`  
Τρόπος πληρωμής: Κάρτα `****7340`

## Parts

| # | Part | Κατηγορία | Ποσότητα | Τιμή μονάδας | Σύνολο | Πωλητής | Εκτιμώμενη παραλαβή | Κατάσταση |
|---:|---|---|---:|---:|---:|---|---|---|
| 1 | DFRobot Κινητήρας DC 12V 251rpm (FIT0186) | Collector | 1 | 23,60 € | 23,60 € | Grobotronics | Τρίτη | Παραλήφθηκε |
| 2 | Male to Male - Pack of 10 Καλώδιο Jumper - 0.15m | Collector | 2 | 1,80 € | 3,60 € | Grobotronics | Τρίτη | Παραλήφθηκε |
| 3 | Haitronic Nano V3 ATmega328P USB cable Board για Arduino | Collector | 1 | 5,70 € | 5,70 € | Hamradio | Έως Τετ, 03 Ιουν | Παραλήφθηκε |
| 4 | MB102 Breadboard Πλακέτα 400 Θέσεων 83x55mm | Collector | 1 | 2,50 € | 2,50 € | A-store | Έως Τετ, 03 Ιουν | Παραλήφθηκε |
| 5 | Power Supply 100-240V 12V 2A 24W 5.5x2.5mm Connector Without Power Cable | Collector | 1 | 6,40 € | 6,40 € | Vexio | Πέμ, 04 Ιουν - Τετ, 10 Ιουν | Παραλήφθηκε |
| 6 | SparkFun Motor Driver - Dual TB6612FNG | Collector | 1 | 6,50 € | 6,50 € | Radel S.A. | Τρίτη | Παραλήφθηκε |
...
> ⚠️ **Safety chain:** το E-stop (#17) πρέπει να κόβει **φυσικά** το +12V στα BTS7960 `B+`, όχι μέσω Arduino. Η main fuse (#16) κοντά στη μπαταρία. Δες `motion-perfboard-wiring-el.md` §2.
